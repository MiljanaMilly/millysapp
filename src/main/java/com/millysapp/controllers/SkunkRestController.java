...
public class SkunkRestController {
    ...
    public ResponseEntity<List<String>> getDataSources(
            @PathVariable("skunkId")UUID skunkId) {
    ...
    public ResponseEntity<String> deleteFromDataSources(
            @PathVariable("skunkId")UUID skunkId,
            @RequestParam("dataSources[]")String[] dataSources) throws SkunkNotFoundException {
